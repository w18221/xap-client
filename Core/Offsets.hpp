...
// HUD
constexpr long OFF_VIEWRENDER = 0x73cc3e0;                    //[Miscellaneous]->ViewRender
...
constexpr long OFF_SHIELD = 0x0438;                           //[RecvTable.DT_TitanSoul]->m_shieldHealth
...
constexpr long OFF_BONES = 0x0d60 + 0x48;                     //m_nForceBone    What is 0x48?
